...
////////copy one//////////////////////////////////////////////////////////////////////////////////////////////  Environment.getExternalStorageDirectory() copy and unzip 2 and check for zip2 after unziping for deleting file  
    ...
    if(thePerc_copy != (tilNowSize_copy / thegameIsofileSize_copy) * ctx.getResources().getInteger(R.integer.percent_game_size_byte)) {
        thePerc_copy = (tilNowSize_copy / thegameIsofileSize_copy) * ctx.getResources().getInteger(R.integer.percent_game_size_byte);
